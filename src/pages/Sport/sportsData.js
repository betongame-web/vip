const baseMarkets = (home, away, homeOdd, drawOdd, awayOdd) => [
  ...
  },
  {
    ...
    name: 'Goals 2.5',
    values: [
      { id: 'over25', value: 'Over 2.5', odd: Number((homeOdd + 0.12).toFixed(2)) },
  ...
  },
  {
    ...
    values: [
      { id: 'yes', value: 'Yes', odd: Number((drawOdd - 0.12).toFixed(2)) },
      { id: 'no', value: 'No', odd: Number((homeOdd + 0.32).toFixed(2)) },
    ],
  },
];
...
export function buildMockSportsData() {
  return [
    ...
    makeEvent(1002, 'Spain', 'La Liga', 'Barcelona', 'Sevilla', '2026-04-13T19:30:00Z', 'Not Started', 0, 0, 'la-liga', true, false, 1.62, 4.10, 5.40),
    makeEvent(1003, 'Italy', 'Serie A', 'Inter', 'Napoli', '2026-04-14T16:00:00Z', 'Not Started', 0, 0, 'serie-a', false, false, 2.02, 3.20, 3.55),
    makeEvent(1004, 'Germany', 'Bundesliga', 'Bayern', 'Leipzig', '2026-04-14T18:30:00Z', 'Not Started', 0, 0, 'bundesliga', true, false, 1.71, 3.70, 4.75),
    makeEvent(1005, 'France', 'Ligue 1', 'PSG', 'Marseille', '2026-04-15T19:00:00Z', 'Not Started', 0, 0, 'ligue-1', false, false, 1.68, 3.95, 5.15),
    makeEvent(1006, 'Europe', 'Champions League', 'Real Madrid', 'Man City', '2026-04-15T20:00:00Z', 'Not Started', 0, 0, 'champions-league', true, false, 2.28, 3.40, 2.82),
    makeEvent(1007, 'Portugal', 'Primeira Liga', 'Benfica', 'Porto', '2026-04-16T18:45:00Z', 'Not Started', 0, 0, 'primeira-liga', false, false, 2.11, 3.10, 3.35),
    ...
    makeEvent(1011, 'Brazil', 'Serie A Brazil', 'Flamengo', 'Palmeiras', '2026-04-18T21:00:00Z', 'Not Started', 0, 0, 'serie-a-brazil', false, false, 2.40, 3.00, 2.95),
    makeEvent(1012, 'USA', 'MLS', 'Inter Miami', 'LAFC', '2026-04-19T00:00:00Z', 'Not Started', 0, 0, 'mls', true, false, 2.03, 3.50, 3.42),
  ];
}